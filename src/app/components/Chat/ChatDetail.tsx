...
const ChatDetail: React.FC<{ setShowMess: React.Dispatch<React.SetStateAction<boolean>> }> = ({ setShowMess }) => {
  ...
  return (
    ...
    >
      <div>
        ...
        >
          <ArrowBackIosIcon className="h-6 w-6 text-gray-100" />
          <span className="ml-2 text-sm font-medium text-gray-100">Back</span>
        </button>
        {/* Phần chat */}
        <div className="p-4 text-black rounded-lg">
          ...
          <div className="flex justify-end mb-3">
            <div className="flex items-center group relative">
              ...
              <Image src={User4} alt="User Image" className='w-10 h-10 rounded-full ml-5' />
