...
const ChatDetail = ({ socket, username }) => {
  ...
  useEffect(() => {
    socket.on(IOChanel.CHAT_CHANEL_RECEIVE, (data) => {
      ...
      console.log(
        "Data receive from chat detail: " + JSON.stringify(messageList)
      );
    });
  }, [socket]);
  return (
    ...
    >
      <div
        style={{
          ...
          maxHeight: "490px" /* Chiều cao tối đa cho phần tin nhắn */,
          scrollbarWidth: "thin" /* Hiển thị thanh cuộn dọc trên Firefox */,
        }}
      >
        <div style={{
            marginTop:"45px",
          ...
          <div className={styles.containerSendMess}>
            ...
            <div className={styles.mess}>
              <div className={styles.detail}>Xin chào hehehehe!</div>
          ...
          <div className={styles.containerReviceMess}>
            ...
            <div className={styles.mess}>
              ...
              <div className={styles.time}>21:50</div>
            </div>
          </div>
          <div className={styles.containerSendMess}>
            <div className={styles.mess}>
          ...
          <div className={styles.containerReviceMess}>
            ...
            <div className={styles.mess}>
              ...
              <Image className={styles.avatar} src={User4} alt="User Image" />
              <div className={styles.name}>Hồ Thành Vinh</div>
              <div className={styles.time}>22:05</div>
            </div>
          </div>
          <div className={styles.containerSendMess}>
            <div className={styles.mess}>
              ...
              <Image className={styles.avatar} src={User1} alt="User Image" />
              <div className={styles.name}>Phan Hoàng Kha</div>
              <div className={styles.time}>22:10</div>
            </div>
          </div>
        </div>
